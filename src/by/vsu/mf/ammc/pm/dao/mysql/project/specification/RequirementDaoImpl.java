...
public class RequirementDaoImpl extends BaseDao implements RequirementDao {
	...
	public Integer create(Requirement object) throws DaoException {
		...
		try {
			...
			statement.setFloat(3, object.getImportance());
			statement.setFloat(4, object.getChangeProbability());
			statement.setInt(5, object.getUseCase().getId());
			statement.setInt(6, object.getModule().getId());
